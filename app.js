...
app.get("/states/", async (request, response) => {
    ...
    response.send(allStatesArray.map((eachObject) => convertDbObjectToResponseObject(eachObject)));
});
...
app.post("/districts/", async (request, response) => {
    ...
    const addingNewDistrict = `INSERT INTO district (district_name,
                                                     state_id,
                                                     cases,
                                                     cured,
                                                     active,
...
app.get("/states/:stateId/state/", async (request, response) => {
    const {stateId} = request.params;
